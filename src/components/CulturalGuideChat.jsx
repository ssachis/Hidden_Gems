...
export default function CulturalGuideChat({ destination, apiKey }) {
  ...
  return (
    <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 h-[500px] animate-fade-in">
      ...
      <div className="md:col-span-1 bg-zinc-950 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 flex flex-col items-center text-center justify-center space-y-3 h-full shadow-sm">
      ...
      {/* Chat Thread Panel */}
      <div className="md:col-span-3 bg-zinc-950 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl flex flex-col justify-between h-full shadow-sm overflow-hidden">
          ...
          {messages.map((msg) => (
            ...
            >
              ...
              <div className={`w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center text-sm ${
                msg.sender === 'user' 
                  ? 'bg-zinc-200 dark:bg-zinc-800 text-zinc-100 dark:text-zinc-200' 
              ...
              <div className="space-y-1">
                <div className={`p-3 rounded-2xl text-xs leading-relaxed ${
                  msg.sender === 'user'
                    ...
                    : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-100 dark:text-zinc-200 rounded-tl-none border border-zinc-200/20'
                }`}>
                  {msg.text}
                </div>
        ...
        <div className="p-4 border-t border-zinc-200/50 dark:border-zinc-800 bg-zinc-900/50 dark:bg-zinc-950/20 space-y-3">
          ...
          <div className="flex flex-wrap gap-1.5">
            {SUGGESTED_PROMPTS.map((promptText, i) => (
              <button
                ...
                className="text-[10px] font-semibold text-zinc-600 dark:text-zinc-400 hover:text-emerald-600 dark:hover:text-emerald-400 bg-zinc-950 dark:bg-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-800 px-2.5 py-1 rounded-full border border-zinc-200 dark:border-zinc-800 flex items-center gap-1 transition-colors"
              >
          ...
          >
            <input
              ...
              className="flex-1 bg-zinc-950 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 text-zinc-950 dark:text-zinc-100 transition-all placeholder:text-zinc-400"
            />
            <button
              type="submit"
